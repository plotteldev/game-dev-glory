  ...
  return (
    <div id="top" className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <section className="px-5 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="max-w-3xl">
              <p className="mb-5 inline-flex rounded-md bg-brand-blue-soft px-3 py-1 text-sm font-semibold text-brand-blue">
                60 minutes &middot; USD $150 &middot; Online
              </p>
              <h1 className="text-4xl font-semibold tracking-tight text-brand-blue sm:text-6xl">
        ...
        <LandingSection id="help" title="What we can work on" className="bg-brand-blue-soft/50">
          <ul className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {helpItems.map((item) => (
              <li
                key={item}
                className="rounded-md border border-border bg-white px-4 py-4 text-sm font-medium text-brand-blue"
              >
                {item}
              </li>
            ))}
        ...
        <LandingSection id="how-it-works" title="How it works">
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {steps.map((step, index) => (
              <article key={step.title} className="rounded-lg border border-border bg-white p-6">
                <p className="mb-5 flex h-9 w-9 items-center justify-center rounded-md bg-brand-yellow text-sm font-semibold text-brand-blue">
                  {index + 1}
                </p>
        ...
        <LandingSection id="about" title="Practical help for stuck Unity devs" className="bg-brand-blue text-white">
        ...
        <section id="book" className="scroll-mt-10 px-5 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="mx-auto max-w-6xl rounded-lg border border-border bg-white p-8 shadow-sm sm:p-10">
